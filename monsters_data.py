class MonstersClues:
    ...
    can_make_people_tell_the_truth = "can make people tell the truth"
...
class MonstersKillMethods:
    ...
    silver_blade_through_the_heart = "silver blade through the heart"
